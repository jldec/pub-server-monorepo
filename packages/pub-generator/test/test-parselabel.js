...
test('parseLabel', function(t) {
  ...
  t.deepEqual(parseLabel('/a.b',true), {_path:'/', _name:'a', _ext:'.b', _extIsFromLabel: false});
  ...
  t.deepEqual(parseLabel('/a.b#c',false), {_path:'/', _name:'a', _ext:'.b', _extIsFromLabel: true, _fragname:'#c'});
  t.deepEqual(parseLabel('/a.B#c',false, {mixedCase:1}), {_path:'/', _name:'a', _ext:'.B', _extIsFromLabel: true, _fragname:'#c'});
  t.deepEqual(parseLabel('/a d.b#c',false), {_path:'/', _name:'a-d', name:'a d', _ext:'.b', _extIsFromLabel: true, _fragname:'#c'});
  t.deepEqual(parseLabel('/a d.b#c d',false), {_path:'/', _name:'a-d', name:'a d', _ext:'.b', _extIsFromLabel: true, _fragname:'#c-d'});
  t.deepEqual(parseLabel('/a d.b d#c d',false), { _path:'/', _name:'a-d', name:'a d', _fragname:'#c-d', _ext:'.b d', _extIsFromLabel: true});
  t.deepEqual(parseLabel('/a#b',true), {_path:'/', _name:'a-b', name:'a#b'});
  t.deepEqual(parseLabel('/a.b#c',true), {_path:'/', _name:'a', _ext:'.b#c', _extIsFromLabel: false});
  t.deepEqual(parseLabel('/a.B#c',true, {mixedCase:1}), {_path:'/', _name:'a', _ext:'.B#c', _extIsFromLabel: false});
  t.deepEqual(parseLabel('/a d.b#c',true), {_path:'/', _name:'a-d', name:'a d', _ext:'.b#c', _extIsFromLabel: false});
  t.deepEqual(parseLabel('/a d.b#c d',true), {_path:'/', _name:'a-d', name:'a d', _ext:'.b#c d', _extIsFromLabel: false});
  t.deepEqual(parseLabel('/a d.b d#c d',true), { _path:'/', _name:'a-d', name:'a d', _ext:'.b d#c d', _extIsFromLabel: false});
  ...
  t.deepEqual(parseLabel('index.md',true), {_name:'index', _ext:'.md', _extIsFromLabel: false});
  t.deepEqual(parseLabel('/index.md',true), {_path:'/', name:'/', _ext:'.md', _extIsFromLabel: false});
  t.deepEqual(parseLabel('/a/b/c/index.md',true), {_path:'/a/b/c/', name:'c', _ext:'.md', _extIsFromLabel: false});
  t.deepEqual(parseLabel('robots.txt.hbs',true), {_name:'robots.txt', _ext:'.hbs', _extIsFromLabel: false});
  t.deepEqual(parseLabel('/a.b/robots.txt.hbs',true), {_path:'/a.b/', _name:'robots.txt', _ext:'.hbs', _extIsFromLabel: false});
  t.deepEqual(parseLabel('/Nice dir/index.md',true), {_path:'/nice-dir/', name:'Nice dir', _ext:'.md', _extIsFromLabel: false});
  t.end();
});
